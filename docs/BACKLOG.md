...
- ~~**Provera javnog sadržaja pre objave (Zadatak 3)**~~ ✅ (11. avgust 2026.) — `docs/serbian-language-facts.md`. Opcioni deo (Claude Code skill za auto-sken draftova) i dalje otvoren, nizak prioritet.
