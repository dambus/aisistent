...
### Verzija 1.1 — dodata sekcija o deklinaciji
...
*Promene u odnosu na v1.0: dodata sekcija SRPSKI JEZIK I DEKLINACIJA, automatska detekcija pola, pojačan user message.*
