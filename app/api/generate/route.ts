...
const ugovorODeluSchema = z.object({
  ...
  broj_lk_narucioca: z.string().optional(),
  ...
  tip_prihoda: z.enum(['autorsko_delo', 'ugovor_o_delu']),
  ...
  ugovorna_kazna: z.boolean().default(false),
  iznos_kazne_dnevno: optNum,
  garantni_rok: optNum,
  napomene: z.string().optional(),
})
...
const ugovorOZakupuSchema = z.object({
  ...
  indeksacija_zakupnine: z.string().optional(),
  pravo_prece_kupovine: z.boolean().default(false),
  tabla_natpis: z.boolean().default(true),
  ...
  broj_gostiju: optNum,
  datum_checkin: z.string().optional(),
  datum_checkout: z.string().optional(),
  turisticka_taksa: z.boolean().default(false),
  napomene: z.string().optional(),
...
const opstiUsloviSchema = z.object({
  ...
  url: z.string().min(1),
  datum_objave: z.string().optional(),
  koristi_kolacice: z.boolean().default(false),
  koristi_google_analytics: z.boolean().default(false),
...
const otpremnicaSchema = z.object({
  ...
  datum_izdavanja: z.string().min(1),
  datum_isporuke: z.string().optional(),
  isporucilac_naziv: z.string().min(1),
  isporucilac_pib: z.string().optional(),
  isporucilac_adresa: z.string().min(1),
...
const fakturaSchema = z.object({
  ...
  medjunarodno_placanje: z.boolean().optional().default(false),
  valuta: z.enum(['EUR', 'USD', 'GBP', 'CHF']).optional(),
  iban: z.string().optional(),
  swift_bic: z.string().optional(),
  naziv_banke: z.string().optional(),
  primalac_naziv: z.string().min(1),
  primalac_pib: z.string().optional(),
  primalac_adresa: z.string().min(1),
  stavke: z.string().min(2),
